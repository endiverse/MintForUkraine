/**
 *Submitted for verification - Etherscan.io - 2022-03-14
*/
...
*/
// ANYONE CAN CREATE NFTs FOR THE UKRAINIAN PEOPLE!
// SIMPLY CALL MINT WITH THE YOUR IPFS METADATA FILE URL
// PAY 0.01 ETH + GAS PER NFT to MINT
// YOU GET THE NFT, UKRAINE GETS THE ETH!

// SAMPLE METADATA:
// ipfs://QmR8WZDTobS3uTMyt863rPMNCm8pGmi1Jm7JLAFSvmTW8u
...
contract UKRAINENFTS is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public constant maticPrice = 100000000000000000; //10.0 MATIC per NFT
    ...
    function safeMint(uint32 _numberOfNFTs, string memory uri) public payable {
      ...
      require(msg.value >= maticPrice * _numberOfNFTs , "insufficient funds for qty requested");
